...
from dt4acc_lib.pyat_simulator.element_proxies import KickAngleCorrectorProxy, ElementProxy


class BESSYIIPyAtAcceleratorSimulator(PyATAcceleratorSimulator):
    def get(self, element_id: str) -> str:
        ...
        if len(elements) == 1:
            ...
            element, = self.acc.get_elements(host_element_id)
