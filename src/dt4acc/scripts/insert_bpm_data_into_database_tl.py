...
from dt4acc.resources import bpm_config_tl
...
# Collections for bpm config and offset
# config_collection = db['bpm.config']
# offset_collection = db['bpm.offset']

# Read the content from the file
bpm_conf = bpm_config_tl.bpm_conf
bpm_offset = bpm_config_tl.bpm_offset
